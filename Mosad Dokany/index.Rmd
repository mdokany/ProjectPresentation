...
- The tool is hosted in this link [here] (https://mosad.shinyapps.io/DevelopingDataProduct/)
...
##slidifyUI
library("shiny")
slidifyLibraries::slidifyUI(radioButtons("transmission","Transmission Type:",
